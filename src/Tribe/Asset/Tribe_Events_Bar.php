...
class Tribe__Events__Asset__Tribe_Events_Bar extends Tribe__Events__Asset__Abstract_Asset {
	...
	public function handle() {
		$deps = array_merge( $this->deps, array(
			...
			Tribe__Events__Views__Base_View::get_placeholder_handle(),
		) );
		$path = Tribe__Events__Views__Base_View::getMinFile( tribe_events_resource_url( 'tribe-events-bar.js' ), true );
