...
class Tribe__Events__Asset__Bootstrap_Datepicker extends Tribe__Events__Asset__Abstract_Asset {
	...
	public function handle() {
		$css_path = Tribe__Events__Views__Base_View::getMinFile( $this->vendor_url . 'bootstrap-datepicker/css/datepicker.css', true );
		$path = Tribe__Events__Views__Base_View::getMinFile( $this->vendor_url . 'bootstrap-datepicker/js/bootstrap-datepicker.min.js', true );
		...
		Tribe__Events__Views__Base_View::add_vendor_script( $handle );
